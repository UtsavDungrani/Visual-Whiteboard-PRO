...
## Corpus Check
- 57 files · ~45,987 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 265 nodes · 326 edges · 15 communities (14 shown, 1 thin omitted)
...
Cohesion: 0.09
Nodes (20): AdminPanel(), AssistPanel(), CanvasControls(), CanvasOverlay(), ContextPanel(), LANGUAGES, ExportModal(), PageStrip() (+12 more)
...
Cohesion: 0.22
Nodes (9): Real-time Collaboration, updateAllConnectors(), useConnectorSync(), App(), ConnectorLine, useConnectorTool(), findClosestAnchor(), getAnchorPoint() (+1 more)
...
- **Why does `Real-time Collaboration` connect `Community 7` to `Backend Server Initialization`, `Editor Specifications & Features`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `App()` connect `Community 7` to `Editor Specifications & Features`, `Frontend Application & Collaboration UI`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `Project Description and Requirements` connect `Editor Specifications & Features` to `Community 10`, `Community 7`?**
