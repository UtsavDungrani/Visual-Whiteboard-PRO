...
## Corpus Check
- 49 files · ~39,034 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 213 nodes · 238 edges · 16 communities (13 shown, 3 thin omitted)
...
Cohesion: 0.33
Nodes (7): bboxCornersInPolygon(), getPathSelectionMode(), isPointInPolygon(), pathDataToSvgD(), sampleFabricPath(), samplePathHitPoints(), splitPathWithLasso()
