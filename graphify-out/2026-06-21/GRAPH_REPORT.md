...
## Corpus Check
- 52 files · ~41,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 221 nodes · 248 edges · 15 communities (12 shown, 3 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `79dbc236`
...
6. `getPathSelectionMode()` - 6 edges
7. `scripts` - 5 edges
8. `scripts` - 4 edges
9. `App()` - 4 edges
10. `isPointInPolygon()` - 4 edges
...
Cohesion: 0.05
Nodes (37): MongoDB Storage, jwt, ElementContextSchema, mongoose, MessageSchema, mongoose, mongoose, WhiteboardSchema (+29 more)
...
Cohesion: 0.09
Nodes (19): AssistPanel(), CanvasControls(), ChatPanel(), ContextPanel(), LANGUAGES, ExportModal(), PageStrip(), PermissionsPanel() (+11 more)
...
## Knowledge Gaps
- **133 isolated node(s):** `husky.sh script`, `name`, `version`, `private`, `dev` (+128 more)
