# Graph Report - Visual Whiteboard Pro  (2026-06-30)

## Corpus Check
- 57 files · ~46,665 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 275 nodes · 357 edges · 16 communities (15 shown, 1 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cf7ef636`
...
Cohesion: 0.18
Nodes (13): Architecture Assist AI, Real-time Collaboration, Context Layer, Drawing Canvas, HTML/CSS Export, PDF Export, Mess Cleanup AI, Multi-Page System (+5 more)
...
Cohesion: 0.10
Nodes (21): AssistPanel(), CanvasControls(), CanvasOverlay(), ContextPanel(), LANGUAGES, ExportModal(), PageStrip(), PermissionsPanel() (+13 more)
...
Cohesion: 0.44
Nodes (5): updateAllConnectors(), ConnectorLine, findClosestAnchor(), getAnchorPoint(), getObjectAnchors()
