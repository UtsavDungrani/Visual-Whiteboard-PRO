...
export default function Toolbar({
  ...
  const toolGroups = [
    {
      ...
      defaultIcon: (
        ...
        >
          ...
          />
          <path
            d="M10 10l5 5-2 1.5 3 3.5-1.5 1.2-3-3.5-2 2z"
            fill="currentColor"
            stroke="none"
          />
        </svg>
      ...
      tools: [
        ...
        },
        {
          ...
          icon: (
            ...
            >
              <path
                d="M20 20H7L3 16C2 15 2 13.5 3 12.5L12.5 3C13.5 2 15 2 16 3L21 8C22 9 22 10.5 21 11.5L12 20.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
      ...
      tools: [
        {
          ...
          icon: (
            ...
            >
              ...
              <path
                d="M9 17h3a2 2 0 002-2V9a2 2 0 012-2h3"
                strokeDasharray="3 3"
              />
            </svg>
          ),
  ...
  useEffect(() => {
    const onPointerMove = (e) => {
      ...
      // Clamp within the viewport (leaving a margin) so the floating toolbar
      // can't be dragged off-screen and lost until reload.
      ...
      setPosition({
        x: Math.min(Math.max(margin, nx), Math.max(margin, maxX)),
        y: Math.min(Math.max(margin, ny), Math.max(margin, maxY)),
      });
    };
      ...
      >
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M4 6h16M4 6v4m16-4v4m-8-4v14m0 0h-3m3 0h3"
          />
        </svg>
      </button>
      ...
      >
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M8 10V7a4 4 0 118 0v3M8 12V7a4 4 0 118 0v5m-8 2v-6a4 4 0 118 0v6m-8 2H6M16 16h2a2 2 0 002-2v-3a2 2 0 00-2-2h-2m-8 7H4a2 2 0 01-2-2v-3a2 2 0 012-2h2m0 7V9"
          />
        </svg>
      </button>
    </div>
